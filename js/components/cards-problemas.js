function createCardView(problemas) {
    return `
        <div id="problema-${problemas.id}" style="    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25); width: 333px; height: 313px; border-radius: 20px; background: var(--White, #FFF); display: flex; justify-content: center;align-items: center; margin: 8px 10px;">
